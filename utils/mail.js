...
exports.sendMail = async (to="bar@example.com", name="User Name", forRole="user") => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'abraham.reinger40@ethereal.email', // generated ethereal user
      pass: 'SFcS4v1d2Bfz3atzuv', // generated ethereal password
    },
  });

  // send mail with defined transport object
  let info = await transporter.sendMail({
    from: '"Admin" <admin@xyz.com>', // sender address
